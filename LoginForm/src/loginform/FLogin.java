...
public class FLogin extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if((txtUsername.getText().equals("nopenul"))&&
                (String.valueOf(txtPassword.getText()).equals("111"))){
            new FUser().setVisible(true);
            dispose();
        }
        else{
            JOptionPane.showMessageDialog(null, txtUsername.getText() + "Username atau Password yang Anda masukkan salah", "Konfirmasi", JOptionPane.ERROR_MESSAGE);
            txtUsername.setText("");
            txtPassword.setText("");
